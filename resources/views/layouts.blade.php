            ...
            <div class="u-nav-container">
                <ul class="u-nav u-unstyled u-nav-1">
                    <li class="u-nav-item"><a
                            ...
                            href="{{route('showAdmins')}}" style="padding: 10px 20px;">Admin</a>
                    </li>
                    <li class="u-nav-item"><a
                            class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base"
                            href="{{route('showProducts')}}" style="padding: 10px 20px;">Product</a>
                    </li>
                    <li class="u-nav-item"><a
                            class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base"
                            href="{{route('showLanguages')}}" style="padding: 10px 20px;">Language</a>
                    </li>
                    <li class="u-nav-item"><a
                            class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base"
                            href="{{route('logoutAdmin')}}" style="padding: 10px 20px;">Logout</a>
                    </li>
                </ul>
            </div>
            @endif
